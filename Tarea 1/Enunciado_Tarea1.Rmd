...
vect_bern_10 <- vector()
vect_bern_100 <- vector()
vect_bern_1000 <- vector()
vect_bern_5000 <- vector()
...
for(i in 1:10) {
  ...
  vect_bern_10 <- append(vect_bern_10, prom_bern)
}
for(i in 1:100) {
  x<-rpois(1000, 5)
  expo <- rexp(1000, 5)
  ...
  vect_bern_100 <- append(vect_bern_100, prom_bern)
}
for(i in 1:1000) {
  x<-rpois(1000, 5)
  expo <- rexp(1000, 5)
  ...
  vect_bern_1000 <- append(vect_bern_1000, prom_bern)
}
for(i in 1:5000) {
  x<-rpois(1000, 5)
  expo <- rexp(1000, 5)
  ...
  vect_bern_5000 <- append(vect_bern_5000, prom_bern)
...
for (lanzamientos in 1:N_lan) {
  ...
  plot(multProb, type="l", col="blue", xlab="Porcentaje de lanzamientos favorables de P(A)P(B)", ylab="Fondos", main="Evolución de la probabilidad de tener lanzamientos favorables")
  plot(probAB, type="l", col="blue", xlab="Porcentaje de lanzamientos favorables de P(AB)", ylab="Fondos", main="Evolución de la probabilidad de tener lanzamientos favorables")
...
for (lanzamientos in 1:N_lan) {
  ...
  plot(multProb, type="l", col="blue", xlab="Porcentaje de victorias al cambiar de puerta", ylab="Fondos", main="Evolución de la probabilidad de ganar al cambiar de puerta")
  plot(probAB, type="l", col="blue", xlab="Porcentaje de victorias al cambiar de puerta", ylab="Fondos", main="Evolución de la probabilidad de ganar al cambiar de puerta")
