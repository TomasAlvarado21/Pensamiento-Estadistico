...
n_juegos <- function(n = 500 ,cambiar_puerta = TRUE){
  ...
  plot(evolution_porcentage_sc, type="l", col="blue", xlab="Porcentaje de victorias sin cambiar de puerta", ylab="Fondos", main="Evolución de la probabilidad de ganar al cambiar de puerta")
}
#montyhall()
n_juegos()
```
