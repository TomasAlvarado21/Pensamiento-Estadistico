...
>$\bar{X}_{new} = \dfrac{1}{m} \sum^{m}_{i=1} ((x_i * 1.1) + 15000) $, la mediana sera la misma, pero con un 10% más y aumentada en 15000 y $sd_{new} = \sqrt{\dfrac{1}{(m-1)}\sum_{i=1}^{m}(((x_i * 1.1) + 15000)-\bar{x})^{2}}$ 
