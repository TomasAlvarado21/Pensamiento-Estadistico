...
for(i in 1:10000) {
  ...
  vect_pois <- append(vect_pois, prom)
  vect_exp <- append(vect_exp, prom_exp)
  vect_bern <- append(vect_bern, prom_bern)
}

hist(vect_pois)
lines(density(vect_pois))

hist(vect_exp)
lines(density(vect_exp))

hist(vect_bern)
lines(density(vect_bern))
